...
app.get("/notes", (req, res) => {
  ...
  if (_id != undefined) {
    ...
    if (key != undefined) {
      Note.findNotesByNotebookAndKey(notebook_id, key)
        .then((result) => {
          const response = result === undefined ? [] : result;
          res.send(response);
        })
      ...
      Note.findNotesByNotebook(notebook_id)
        .then((result) => {
          const response = result === undefined ? [] : result;
          res.send(response);
        })
    ...
    if (key != undefined) {
      Note.findNotesByUserAndKey(user_id, key)
        .then((result) => {
          const response = result === undefined ? [] : result;
          res.send(response);
        })
